...
class SMS(models.Model):
    ...
    gateway = models.IntegerField(choices=GATEWAY_CHOICES, default=0, verbose_name=_(u'gateway'),
                                  help_text=_(u'By which provider the SMS was handled.'))
    backend = models.CharField(max_length=32, db_index=True, default='unknown', verbose_name=_(u'backend'))
    gateway_ref = models.CharField(max_length=64, blank=True, verbose_name=_(u'gateway reference'),
